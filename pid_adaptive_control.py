...
It uses the configuration from config/pid_adaptive.json by default.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python pid_adaptive_control.py
  python pid_adaptive_control.py config/pid_adaptive.json
  python pid_adaptive_control.py config/pid_adaptive.json 0
        """
    )
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="config/pid_adaptive.json",
        help="Path to input JSON configuration file (default: config/pid_adaptive.json)"
    )
